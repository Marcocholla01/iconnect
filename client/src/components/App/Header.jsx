...
const Header = ({ active }) => {
  ...
  //Login Api Request and form validation
  ...
  // Register Api request and Form validation
  const handleRegisterSubmit = (e) => {
    e.preventDefault();
    if (!name) {
      toast.error(`Names Required`);
      return;
    }
    if (!registerEmail) {
      toast.error(`Email Required`);
  ...
  return (
    <>
      <header className="header-hide w-full z-[9999] fixed  shadow-md">
        <div className="flex font-Poppins items-center justify-evenly h-[6vh] bg-white w-full">
          {/* <div className="flex text-blue-700 font-bold ">
          <FaBars size={30} />
        </div> */}
          <div>
          ...
          <div className="flex  justify-between gap-10 items-center">
            ...
            <div className="items-center gap-x-3 mt-6 md:mt-0 sm:flex">
              <a
                ...
                className="block px-4 py-2 text-center text-white duration-150 font-medium bg-blue-600 rounded-lg hover:bg-blue-500 active:bg-blue-700 md:text-sm"
            ...
            {/* <div
              className="md:flex font-bold cursor-pointer"
      ...
      {login && (
        <div>
          {/* <!-- Div with fixed position, covering the whole screen --> */}
          <div className="fixed inset-0 w-full h-full flex items-center justify-center z-[2000]">
            ...
            <main className="relative w-full md:w-[40%] h-screen md:h-[80%] flex flex-col items-center justify-center bg-gray-50 sm:px-4 rounded-md">
              <div className="px-2 relative">
                <button
                  className="w-12 h-12 mb-5 rounded-full duration-150 bg-gray-50 hover:bg-gray-300 text-gray-800  cursor-pointer absolute -top-[62px] -right-[220px]"
                  onClick={() => setLogin(false)}
                >
                  <svg
                ...
                <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                  ...
                  <div className="bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                    ...
                    <form onSubmit={handleLoginSubmit} className="space-y-5">
                      ...
                      <button className="w-full px-4 py-2 text-white font-medium bg-blue-600 hover:bg-blue-500 active:bg-blue-600 rounded-lg duration-150 uppercase">
                        Sign in
                      </button>
                    </form>
                  </div>
      ...
      {register && (
        <div>
          ...
          <div className="fixed inset-0 w-full h-full flex items-center justify-center z-[2000]">
            ...
            <main className="transition ease-in-out delay-300 mt-[6vh] relative w-full md:w-[40%] h-screen md:h-[90%] flex flex-col items-center justify-center bg-gray-50 sm:px-4 rounded-md">
              <div className="px-2 relative">
                <button
                  className="w-12 h-12 mb-5 rounded-full duration-150 bg-gray-50 hover:bg-gray-300 text-gray-800 cursor-pointer absolute -top-[40px] -right-[180px]"
                  onClick={() => setRegister(false)}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
