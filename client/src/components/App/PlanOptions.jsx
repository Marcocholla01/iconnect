      ...
      <Motion>
        <div className="md:flex flex-row p-4 justify-center gap-10 text-center">
          <div className="flex gap-4 items-center justify-center ">
            <BiSolidBarChartAlt2 size={150} className="text-blue-800" />
            <div className="mt-8">
              <h3 className=" mb-2 border-b-2 border-blue-800">
          ...
          <div className="flex justify-between gap-4 items-center">
            <FaDatabase size={150} className="text-blue-800" />
            <div className="mt-8">
              <h3 className=" mb-2 border-b-2 border-blue-800">
                No Data Limits
              </h3>
          ...
          <div className="flex justify-between gap-4 items-center">
            <PiVideoCameraFill size={150} className="text-blue-800" />
            <div className="mt-8">
              <h3 className=" mb-2 border-b-2 border-blue-800">
                Video Streaming
              </h3>
